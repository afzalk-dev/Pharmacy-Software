   ...
   $stall_no= $n."".$l; ?>
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number No." autocomplete="off"/>
                                               </div>
          ...
          <thead>
            <tr>              
              ...
              <th style="width:20%;">Qty(Pkt)</th>
              <th style="width:10%;">Qty(Pss)</th>
          ...
          <tbody>
            ...
            for($x = 1; $x < 2; $x++) { ?>
              <tr id="row<?php echo $x; ?>" class="<?php echo $arrayNumber; ?>">                
                ...
                <p  name="rate[]" id="rate<?php echo $x; ?>" ></p>  
                <input type="number" name="quantity[]" id="quantity<?php echo $x; ?>" onkeyup="getTotal(<?php echo $x ?>)" autocomplete="off" class="form-control" />             
                  ...
                  <!-- <input type="text" name="rateValue[]" id="rateValue<?php echo $x; ?>" autocomplete="off" class="form-control" />                   -->
                </td>
              <td style="padding-left:20px;">
                  <div class="form-group">
                  <p id="pssrate<?php echo $x; ?>" name="pssrate" ></p>
                  <input type="number" name="qtypss[]" id="qtypss<?php echo $x; ?>" onkeyup="pssRateFunc(<?php echo $x ?>)" autocomplete="off" class="form-control"  />
                  </div>
                    </td>
                <td style="padding-left:20px;">
                  <div class="form-group">
  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+                
        ...
        '</td>'+
        '<td style="padding-left:20px;"">'+
        ' <p  name="rate[]" id="rate'+count+'" ></p> ' + 
                '<input type="number" name="quantity[]" id="quantity'+count+'" onkeyup="getTotal('+count+')" autocomplete="off" class="form-control" /> '+
          // '<input type="text" name="rate[]" id="rate'+count+'" autocomplete="off" disabled="true" class="form-control" />'+
          // '<input type="hidden" name="rateValue[]" id="rateValue'+count+'" autocomplete="off" class="form-control" />'+
        '</td style="padding-left:20px;">'+
        '<td style="padding-left:20px;">'+
          '<div class="form-group">'+
          '<p id="pssrate'+count+'" name="pssrate" ></p>'+
                 ' <input type="number" name="qtypss[]" id="qtypss'+count+'" onkeyup="pssRateFunc('+count+')" autocomplete="off" class="form-control"  />'+
          // '<p id="available_quantity'+count+'"></p>'+
          // '<input type="number" name="pssrate[]" id="pssrate'+count+'" onkeyup="pssRateFunc('+count+')" autocomplete="off" class="form-control"  />'+
          '</div>'+
        '</td>'+
        '<td style="padding-left:20px;">'+
          '<div class="form-group">'+
    ...
    if(productId == "") {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#rate"+row).val(response.rate).text(response.rate);
          // $("#rateValue"+row).val(response.rate);
          $("#pssrate"+row).val(response.pss_rate).text(response.pss_rate);
          $("#quantity"+row).val();
          $("#qtypss"+row).val();
...
function getTotal(row = null) {
  if(row) {
    ...
    var qtypss = Number($("#qtypss" + row).val());
  var rate = Number($("#rate" + row).val());
  var pssRate = Number($("#pssrate" + row).val());

  // Calculate total considering both rate and pssrate
  var total = (quantity * rate) + (qtypss * pssRate);
