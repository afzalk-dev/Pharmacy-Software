                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                              ...
                                              <label class="col-sm-2 control-label">Invoice No</label>
                                               <div class="col-sm-4">
                                                <?php 
$user ="select * from purchase_invoice where  pid=(select max(pid) from purchase_invoice)";
//echo $user;exit;
   ...
   $stall_no= $n."".$l; ?>
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                 <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Company Bill No." autocomplete="off" />
                                               </div>
  ...
  $.ajax({
    ...
    success:function(response) {
      ...
      var tr = '<tr id="row'+count+'" class="'+arrayNumber+'">'+                
        ...
        '<td style="padding-left:20px;">'+
          '<div class="form-group">'+
          '<input type="number" name="disc[]" id="disc'+count+'" onkeyup="discAmount('+count+')" autocomplete="off" class="form-control"  />'+
          // '<input type="number" name="quantity[]" id="quantity'+count+'" onkeyup="getTotal('+count+')" autocomplete="off" class="form-control" min="1" />'+
          '</div>'+
        '</td>'+
        '<td style="padding-left:20px;">'+
