					...
					<td colspan="8">
						<table>
							<tr> 
								...
								<td >
									<h2 style="margin:0 0 11px;">Invoice</h2><b> #:</b> <?php echo $row['uno'] ?><br />
									<b>Date:</b> <?php echo $row['orderDate'] ?><br />
...
<?php } ?>
								<td>
									<b>Name : </b> <?php echo $row['clientName'] ?>
									<br />
									<b>Contact : </b><?php echo $row['clientContact'] ?>
									<br />
...
<?php 
							 require_once('constant/connect.php');
								$sql2 = "SELECT productName,total,rate, qty_pss, quantity FROM order_item WHERE lastid='".$_GET['id']."' ";
              //echo $sql2;exit;
...
<td><?php
					...
					<td><?php echo $row2['qty_pss'] ?></td>

					<td><?php echo $row2['total']; ?></td>
					
					<td><?php echo $pepsi['discount'] ?></td>
				</tr>
				<!-- <tr>
...
//           $words[$point = $point % 10] : '';
 ...
 ?> 
 <td colspan="6"><b>Total Amount: </b> <?php echo $pepsi['grandTotalValue'];  //echo $result . "Rupees  " . $points;?></b></td>
