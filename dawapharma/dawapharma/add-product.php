                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                        ...
                                        <div class="form-group col-md-3">
                                                <label class="control-label">MRP</label>
                                                   <input type="number" class="form-control" id="mrpno" placeholder="MRP" name="mrp" autocomplete="off" required="" pattern="^[0-9]+$"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                                <label class="control-label">T.P</label>
                                                   <input type="number" class="form-control" id="tp" placeholder="T.P" name="bno"  />
                                        </div>
                                        <div class="form-group col-md-3">
                                                <label class="control-label">Qty(Pss) Rate</label>
                                                  <input type="text" class="form-control" id="qtypssrate" placeholder="Quantity(Pss) Rate" name="qtypss" autocomplete="off"  required="" pattern="^[0-9]+$"/>
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-3">
                                                <label class="control-label">Formulation</label>
                                                   <input type="text" class="form-control" id="frm" placeholder="Formulation" name="frm" autocomplete="off" required="" />
                                        </div>
                                        <div class="form-group col-md-3">
